gsap.set('.main', {position:'fixed', width:'100%', maxWidth:'100%', height:'100%', top:0, left:'50%', x:'-50%'})
gsap.set('.mundo', {background:'#ef6093', maxWidth:'100%', height:'72%', top:0, left:'0%', x:'0%', padding:'90px 0px 0px 0px'})
gsap.set('.mundo2', {background:'#eaab4e', maxWidth:'100%', height:'72%', top:0, left:'0%', x:'0%', padding:'90px 0px 0px 0px'})
gsap.set('.scrollDist', {width:'100%', height:'270%'})
gsap.timeline({scrollTrigger:{trigger:'.scrollDist', start:'top top', end:'bottom bottom', scrub:1}})
    .fromTo('.sky', {y:0},{y:-100}, 0)
    .fromTo('.cloud1', {y:100},{y:-800}, 0)
    .fromTo('.cloud2', {y:-150},{y:-500}, 0)
    .fromTo('.cloud3', {y:-50},{y:-60}, 0)
